...
parser.add_argument("--maxGenomesMissing", metavar="#", type=int, default=0, help="minimum number of genomes with homolog to be included, has priority over minPropPresent")
parser.add_argument("--minPropPresent", metavar="proportion", type=float, default=1.0, help="minimum proportion of genomes with homolog to be included [1.00]")
parser.add_argument("--maxAllowedDups", metavar="maxDups", type=int, default=0, help="maximum duplicated gene occurrences within genomes for homolog to be included [0]")
parser.add_argument("--endGapTrimThreshold", metavar="maxPropGaps", type=float, default=0.2, help="stringency of end-gap trimming, lower for less trimming [0.2]")
...
parser.add_argument("--analyzeBoth", action='store_true', help="set this flag to analyze both codosn and proteins")
parser.add_argument("--raxmlNumThreads", metavar="T", type=int, default=1, help="number of threads for raxml [1]")
parser.add_argument("--runRaxml", action='store_true', help="set this flag if you want to run raxml later manually (command file provided)")
